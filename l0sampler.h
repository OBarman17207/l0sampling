...
void update_one_sparse_recovery_CF(struct one_sparse* one, int64_t index, int64_t delta_freq, int zeta, int prpime);
...
bool test_one_sparse_recovery_CF(struct one_sparse *one, int zeta, int prime);
